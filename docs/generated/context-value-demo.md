...
- You start from about `4212` tokens instead of `23837` across the broader docs set.
- You can discover `3` surfaces, `3` reusable agents, and `3` reusable tools without replaying chat history.
- Ambiguous tasks can fall back to retrieval over `248` indexed chunks.
...
| --- | --- | --- |
| Small start bundle | PASS | 4212 tokens vs 23837 tokens across all docs (82.3% smaller) |
| Discovery works without chat memory | PASS | 3 surfaces, 3 agents, 3 tools |
| Ambiguity has a retrieval escape hatch | PASS | 248 retrieval chunks across 34 sources |
