...
- You start from about `4520` tokens instead of `87680` across the broader docs set.
- You can discover `3` surfaces, `3` reusable agents, and `3` reusable tools without replaying chat history.
- Ambiguous tasks can fall back to retrieval over `301` indexed chunks.
...
| --- | --- | --- |
| Small start bundle | PASS | 4520 tokens vs 87680 tokens across all docs (94.8% smaller) |
| Discovery works without chat memory | PASS | 3 surfaces, 3 agents, 3 tools |
| Ambiguity has a retrieval escape hatch | PASS | 301 retrieval chunks across 34 sources |
