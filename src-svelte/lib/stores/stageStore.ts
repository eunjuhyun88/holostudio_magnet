...
const STAGE_PAGES: Record<DisclosureStage, AppView[]> = {
  1: ['home', 'studio'],
  2: ['home', 'studio', 'research-lab'],
  3: ['home', 'studio', 'research-lab', 'models', 'model-detail'],
  4: ['home', 'studio', 'research-lab', 'models', 'model-detail', 'network'],
  5: ['home', 'studio', 'research-lab', 'models', 'model-detail', 'network', 'protocol', 'pipeline'],
};
